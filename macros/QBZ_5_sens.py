...
class QBZ5Sens:
   ...
   # def exec_macros(scope_multiplier):
        ...
        For win 3840x2160 with 150% percent view, mouse sensitivity 5 and in game vertical recoil 0.42.
       ...
       # for x in range(32):
        ...
        def exec_macros(scope_multiplier):
            ...
            for x in range(2):
                ...
                windll.user32.mouse_event(1, 0, round(6.85 * scope_multiplier), 0, 0)
                time.sleep(0.022)
            ...
            for x in range(8):
                ...
                windll.user32.mouse_event(1, 0, round(5.7 * scope_multiplier), 0, 0)
                time.sleep(0.022)
            ...
            for x in range(32):
                ...
                windll.user32.mouse_event(1, 0, round(4.5 * scope_multiplier), 0, 0)
                time.sleep(0.022)
            ...
            for x in range(70):
                ...
                windll.user32.mouse_event(1, 0, round(7.4 * scope_multiplier), 0, 0)
                time.sleep(0.022)
